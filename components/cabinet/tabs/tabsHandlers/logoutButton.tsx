...
const LogoutButton:FC<{clickHandler : () => void,text : string}> = ({clickHandler,text}) => {
    return(
        <>
            <li
                className="cabinet_btn flex justify-between items-center gap-[10px] py-2 border-t border-b border-transparent cursor-pointer hover:border-t hover:border-b hover:border-[#46B1F0] duration-200 group sm:flex-row-reverse"
