            ...
            <div
                ...
                <div className="max-w-[372px] mx-auto mt-8">
                    <div className="bg-[#F6F6F6] px-4 pb-4 pt-16 rounded-3xl relative">
                        ...
                        <div className="text-lg font-medium text-[#333E48] mb-5 text-center">Скинути пароль
                        </div>
                        <form onSubmit={handleSubmit(onFormSubmit)}>
                            <label className="text-[#46B1F0] text-lg font-medium mb-2 block" htmlFor="resetemail">Введіть email</label>
